      ...
      >
        ...
        <div className="fixed top-0 right-0 z-50 flex justify-end bg-white px-4 py-4 mt-8 mr-11 rounded-[46px] ">
          <div className="bg-white rounded-2xl hover:scale-105 transition-transform duration-200">
            <img src="/qrPortfolio.png" alt="QR Code" className="w-20 h-20" />
          </div>
        </div>

        <div className="relative h-[700vh] p-6 bg-white">
          ...
          <section className="sticky z-1 pt-4 bg-white">
            <Services />
          </section>
          <section className="sticky top-0 h-screen z-1 pt-4 bg-white">
            <AboutUs />
          </section>
          <section className="sticky top-0 h-screen z-10 pt-4 bg-white">
            <Contact />
          </section>
        </div>
      </ReactLenis>
